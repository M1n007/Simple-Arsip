<?php
  if (isset($_POST['dispo'])) {
    ...
    $disposisi = mysqli_query($konek,
      "insert into disposisi(no_disposisi, no_surat, tgl_dispo, penerima, judul, catatan, pengirim) values('$no_dispo', '$no_surat', '$tanggal', '$kepada', '$judul', '$catatan', '$pengirim')"
    );
      ...
      <div class="modal-body">
        <form method="POST" action="" enctype="multipart/form-data">
          <div class="form-group">
            ...
            $noSur = $datadis['maxDis'];

            $noUrut = (int) substr($noSur, 6, 6);
            $noUrut++;

            $char = "DISPO";
            $newDISPO = $char . sprintf("%03s", $noUrut);
             ?>
            ...
            <input class="form-control" type="text" id="tanggal4" name="tgl_dispo" value=""/>
